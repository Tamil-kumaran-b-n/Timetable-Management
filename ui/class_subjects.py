...
from database.database import get_all_classes, get_all_subjects, get_all_faculty, assign_subject_to_class, get_all_class_subjects, get_class_subjects_by_class, delete_class_subject
...
class ClassSubjectsWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(['ID', 'Class Name', 'Subject Code', 'Subject Name', 'Faculty', 'Weekly Hours', 'Type'])
    ...
    def assign_subject(self):
        ...
        try:
            ...
            return
        success, msg = assign_subject_to_class(class_id=class_id, subject_id=subject_id, faculty_id=faculty_id, hours_per_week=hrs)
        if success:
    ...
    def delete_assignment(self):
        if not self.selected_mapping_id:
            ...
            return
        confirm = QMessageBox.question(self, 'Confirm Removal', 'Are you sure you want to remove this subject assignment?', QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
